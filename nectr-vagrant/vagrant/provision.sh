...
repo_name="nectrvagrant"
project_name="nectR"
repo_dir="/home/vagrant/nectrvagrant"
project_dir="/home/vagrant/nectrvagrant/src"
django_reqs="/home/vagrant/nectrvagrant/requirements/dev.txt"
virtualenv_dir="/home/vagrant/.virtualenvs"
db_engine="postgres"
db_user="nectrdev"
db_password="nectRVagrantDevPassword"
db_host="localhost"
db_name="nectrdev"
os_user="vagrant"
...
expect $repo_dir/vagrant/expects/set_admin.exp ${os_user} ${repo_name} ${repo_dir} ${db_user} foxb@farmingdale.edu ${db_password}
